...
public class MessageHandler {
    ...
    /** A reply plus the reason it carried no value; see {@link Outcome}. */
    public record Reply(Optional<Object[]> value, Outcome outcome) {
        static Reply ok(Object[] v) { return new Reply(Optional.ofNullable(v), Outcome.OK); }
        static Reply failed(Outcome o) { return new Reply(Optional.empty(), o); }
    }
            ...
            if (response instanceof org.freedesktop.dbus.messages.Error) {
                ...
                switch (error) {
                    case "org.freedesktop.Secret.Error.NoSuchObject":
                        ...
                        return Reply.failed(Outcome.ABSENT);
                    ...
                    case "org.freedesktop.Secret.Error.NoSession":
                        ...
                        logParameterised(error, parameters, Level.WARN);
                        return Reply.failed(Outcome.UNAVAILABLE);
                    ...
                    case "org.freedesktop.Secret.Error.IsLocked":
                        ...
                        return Reply.failed(Outcome.DENIED);
    ...
    public Reply getPropertyChecked(String service, String path, String iface, String property) {
        return sendChecked(service, path, Static.DBus.Interfaces.DBUS_PROPERTIES,
